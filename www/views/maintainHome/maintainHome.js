/**
 * Created by danding on 16/12/31.
 */
/**
...
angular.module('starter')
    ...
    .controller('maintainHomeController',function($scope,$state,$http,$rootScope,
        ...
        $scope.init_map=function (BMap) {
            ...
            var cb=function () {
                var map = new BMap.Map("maintainHome");// 创建地图实例
                $rootScope.maintainHome=map;
        ...
        $scope.serviceSelect=function () {
            $state.go('map_district_result',{params:JSON.stringify({service:'maintain',maintain:$scope.maintain,type:$scope.type})});
        }
