                                  ...
                                  if (json.data == true) {
                                      ...
                                      confirmPopup.then(function (res) {
                                          if (res) {
                                              ...
                                              //TODO:validate the person has insurance_info_person_info or not
                                              $http({
                                                  method: "POST",
                                                  url: Proxy.local() + "/svr/request",
                                                  headers: {
                                                  ...
                                                  if (json.data == true) {
                                                      ...
                                                      {
                                                          //创建新的合法保险人信息
                                                          $scope.createInsurancePerson($scope.car_insurance.insuranceder.perName).then(function(json) {
                                                              ...
                                                              if (res) {
                                                                  if($scope.car_insurance.insuranceder.perIdCard1_img==undefined||$scope.car_insurance.insuranceder.perIdCard1_img==null)
                                                                    $scope.addAttachment($scope.car_insurance.insuranceder, 'perIdCard1_img');
                                                                      ...
                                                                      $scope.addAttachment($scope.car_insurance.insuranceder, 'perIdCard2_img');
                                                              } else {
                                                              }
                                                          });
                                                      }
