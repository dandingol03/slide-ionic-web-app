...
angular.module('starter')
  ...
  .controller('appendLifeInsurerController',function($scope,$state,$http, $location,
    ...
    $scope.tab_change=function(i) {
     ...
     $scope.imgArrs=['perIdCard1_img','perIdCard2_img'];$scope.changePhotoIndex=function(i){
    ...
    if($stateParams.info!==undefined&&$stateParams.info!==null)
    {
      ...
      if(info.order!==undefined&&info.order!==null){
          ...
          $scope.insure=$scope.order.insure;
      }
        ...
        if($scope.insurer.perIdCard1_img!==undefined&&$scope.insurer.perIdCard1_img!==null)
        {
            if($scope.insurer.perIdCard2_img!==undefined&&$scope.insurer.perIdCard2_img!==null)
            {
                    ...
                    $http({
                        ...
                        data:
                            {
                                request:'validatePerNameRedundancy',//infoPersonInfo里有没有这个人名
                                info:{
                            ...
                            confirmPopup.then(function (res) {
                                if(res) {
                                    ...
                                    $http({
                                        ...
                                        data: {
                                            request: 'validateIsLegitimateInsurancePersonOrNot',//InsuranceInfoPersonInfo表里有没有这个人,根据personId
                                            info:{
                                                perName:$scope.insurer.perName
                                            }
                                        }
                                        ...
                                        if(json.data==true)
                                        {
                                            ...
                                            {
                                                $scope.createInsurancePerson($scope.insurer.perName)
                                                    .then(function(json) {
